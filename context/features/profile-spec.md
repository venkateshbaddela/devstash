...
- Provide access to add or change avatar with own image image file.
...
- Avatar logic: Use GitHub avatar from OAuth if available, otherwise generate initials from name/email and also provide access to add or changeown image/avatar file.
